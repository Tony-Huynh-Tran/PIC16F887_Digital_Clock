...
> **Note:**  
> This project utilizes the **DS3231 Real-Time Clock (RTC)** module for accurate timekeeping.  
> All time-related operations, including second, minute, hour, date, month, and year tracking, are handled via the DS3231 through the I²C communication interface.  
> The DS3231 is renowned for its high precision and built-in temperature-compensated crystal oscillator (TCXO), ensuring long-term stability and minimal drift.
